...
class ReconciliationQuery:
    ...
    def __init__(self, query, type_=None, limit=DEFAULT_LIMIT, properties=None, type_strict=None):
        ...
        if type_strict and type_strict not in ["should", "all", "any"]:
            raise BadReconciliationQuery("Type Strict should be 'should', 'all' or 'any'")
